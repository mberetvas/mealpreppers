...
/**
 * Resolves the **Trace ID** for the incoming request following **Trace Header Precedence**:
 * 1. `x-trace-id` header
...
/**
 * Middleware that resolves the **Trace ID** for every request using **Trace Header Precedence**,
 * stores it as the **Request Context Trace ID** on `event.context.traceId`, and echoes it back
 * via the `x-trace-id` response header for observability.
 */
...
/** Retrieves the **Request Context Trace ID** from the event context for request-scoped logging. */
