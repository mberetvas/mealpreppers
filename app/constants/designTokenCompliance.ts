 ...
 * Recipe flows, catalog cards, filter picker, form status surfaces, and
 * planner cards must not embed raw hex/rgb literals; use Tailwind semantic
 * colors (`primary`, `surface`, …) or `atelier/*` roles backed by CSS variables
